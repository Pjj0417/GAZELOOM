...
parser.add_argument("--model_name", type=str, default="gazeloom_dinov2_vitl14_inout")
parser.add_argument("--ckpt_path", type=str, default="./checkpoints/gazeloom_dinov2_vitl14_inout.pt")
