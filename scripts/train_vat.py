...
from gazeloom.utils import vat_auc, vat_l2

parser = argparse.ArgumentParser()
parser.add_argument('--model', type=str, default="gazeloom_dinov2_vitb14_inout")
parser.add_argument('--init_ckpt', type=str, default='./checkpoints/gazeloome_dinov2_vitb14.pt', help='checkpoint for initialization (trained on GazeFollow)')
